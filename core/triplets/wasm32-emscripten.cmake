...
# Shared with the engine and the Skia prebuilt (JetBrains/skia wasm, emsdk 4.0.7):
# native wasm exceptions and longjmp, no threads.
set(VCPKG_C_FLAGS "-fwasm-exceptions -sSUPPORT_LONGJMP=wasm")
set(VCPKG_CXX_FLAGS "-fwasm-exceptions -sSUPPORT_LONGJMP=wasm")
set(VCPKG_LINKER_FLAGS "-fwasm-exceptions -sSUPPORT_LONGJMP=wasm")
